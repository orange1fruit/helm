...
package lint // import "github.com/orange1fruit/helm/v3/pkg/lint"

import (
	"path/filepath"

	"github.com/orange1fruit/helm/v3/pkg/lint/rules"
	"github.com/orange1fruit/helm/v3/pkg/lint/support"
)
